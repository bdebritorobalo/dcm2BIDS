...
RawFolder = fullfile(output_root,'BRAIN_ONLY_nii');
OutputFolder = fullfile(output_root,'BRAIN_ONLY_BIDS');
...
SubjectsFoder = dir(RawFolder);
for subj_id=3:13 %length(SubjectsFolder) %run from 1 to 45 with
