...
output_root = '/Users/brunorobalo/Desktop/HPC33/pmc_npsy/MRIProjects/LimbicSystem/';
addpath(genpath('/Users/brunorobalo/Documents/MATLAB/spm12'));
% addpath(genpath('/Users/brunorobalo/Documents/MATLAB/bids-matlab-master'));
...
RawFolder = fullfile(output_root,'raw_nii');
...
for subj_id=4:length(SubjectsFolder)
...
%                                 movefile(fullfile(full_sub_ses_path, nii_file(n_nii).name),  fullfile(category_out_folder, [final_prefix,nii_file(n_nii).name]))
