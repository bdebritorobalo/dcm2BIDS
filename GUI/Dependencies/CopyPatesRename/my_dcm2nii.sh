...
input_dir="/hpc/shared/pmc_npsy/MRIProjects/LimbicSystem/sourcedata"
out_dir="/hpc/shared/pmc_npsy/MRIProjects/LimbicSystem/raw_nii"
...
#-------------read sessions----######
   for sesname in $input_dir/$filename/ses* ; do
      ...
      #/home/pmc_research/bdebritorobalo/dcm2niix  -f %p_%t -o $sesdir $dicom_dir    #run dcm2nii
